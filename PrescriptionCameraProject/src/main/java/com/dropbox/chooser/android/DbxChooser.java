...
public class DbxChooser {
    ...
    public static class Result {
         ...
         * If the request code doesn't match the one provided to {@link com.dropbox.chooser.android.DbxChooser#launch(android.app.Activity, int)} or if the result code
